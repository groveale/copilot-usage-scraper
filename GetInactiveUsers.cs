...
namespace groveale
{
    public class GetInactiveUsers
    {
        ...
        public GetInactiveUsers(ILogger<GetInactiveUsers> logger, ICopilotUsageSnapshotService copilotUsageSnapshotService)
        {
        ...
        public async Task <IActionResult> Run([HttpTrigger(AuthorizationLevel.Anonymous, "get", "post")] HttpRequest req)
        {
            ...
            var users = await _copilotUsageSnapshotService.GetInactiveUsers(days);
